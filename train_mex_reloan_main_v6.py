...
# Repo root on sys.path when run as ``python train_mex_reloan_main_v6.py``
...
ARTIFACT_DIR = Path(os.environ.get("MEX_RELOAN_ARTIFACT_DIR", _REPO_ROOT / "artifacts" / "mex_reloan_main_v6"))
