...
Example::
    ...
    PYTHONPATH=. python generate_report.py /data1/bogeng/data_output/model_eval_test_run
    PYTHONPATH=. python generate_report.py /path/to/run --pdf-name my_report.pdf
"""
